  ...
  <div class="container">
    ...
    <div class="presentation">
      ...
      <div class="card-alignement">
        ...
        <Card @expand-card="handleCardExpansion($event)" id="2" titleText="OCR" html="Utilisation d'un OCR sur des documents scannés, interprétation des résultats, algorithme de reconnaissance des erreurs." image="mlkit.png"
              ...
              second-block="Dans la globalité, j'ai pu travailler sur les points suivants :"
        ...
        ></Card>
        <Card @expand-card="handleCardExpansion($event)" id="3" titleText="Vue.js" html="Élaboration de différentes interfaces, test des limites du framework, rédaction d'une documentation complète pour des novices." image="logo.svg"
              ...
              second-block="Je peux synthétiser mon travail sur les points suivants :"
